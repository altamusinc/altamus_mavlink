...
/**
 * @brief Get field uptime from system_status message
 *
 * @return [seconds]  Device uptime in seconds 
 */
static inline uint16_t mavlink_msg_system_status_get_uptime(const mavlink_message_t* msg)
{
