...
typedef struct __mavlink_component_health_test_t {
 uint8_t component; /*<   Which component(s) to request retest for*/
} mavlink_component_health_test_t;

#define MAVLINK_MSG_ID_COMPONENT_HEALTH_TEST_LEN 1
#define MAVLINK_MSG_ID_COMPONENT_HEALTH_TEST_MIN_LEN 1
#define MAVLINK_MSG_ID_8_LEN 1
#define MAVLINK_MSG_ID_8_MIN_LEN 1

#define MAVLINK_MSG_ID_COMPONENT_HEALTH_TEST_CRC 199
#define MAVLINK_MSG_ID_8_CRC 199
...
#define MAVLINK_MESSAGE_INFO_COMPONENT_HEALTH_TEST { \
    ...
    1, \
    {  { "component", NULL, MAVLINK_TYPE_UINT8_T, 0, 0, offsetof(mavlink_component_health_test_t, component) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_COMPONENT_HEALTH_TEST { \
...
static inline void mavlink_msg_component_health_test_send(mavlink_channel_t chan, uint8_t component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_COMPONENT_HEALTH_TEST_LEN];
    _mav_put_uint8_t(buf, 0, component);
 ...
 */
static inline void mavlink_msg_component_health_test_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint8_t component)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
 ...
 */
static inline uint8_t mavlink_msg_component_health_test_get_component(const mavlink_message_t* msg)
{
