...
#define MAVLINK_MSG_ID_SCAN_SETTINGS_LEN 24
#define MAVLINK_MSG_ID_SCAN_SETTINGS_MIN_LEN 24
#define MAVLINK_MSG_ID_9_LEN 24
#define MAVLINK_MSG_ID_9_MIN_LEN 24

#define MAVLINK_MSG_ID_SCAN_SETTINGS_CRC 155
#define MAVLINK_MSG_ID_9_CRC 155
...
#define MAVLINK_MESSAGE_INFO_SCAN_SETTINGS { \
    ...
    {  { "yaw_start", NULL, MAVLINK_TYPE_FLOAT, 0, 0, offsetof(mavlink_scan_settings_t, yaw_start) }, \
         ...
         { "point_spacing", NULL, MAVLINK_TYPE_FLOAT, 0, 16, offsetof(mavlink_scan_settings_t, point_spacing) }, \
         { "scan_speed", NULL, MAVLINK_TYPE_FLOAT, 0, 20, offsetof(mavlink_scan_settings_t, scan_speed) }, \
         } \
}
#else
#define MAVLINK_MESSAGE_INFO_SCAN_SETTINGS { \
...
static inline uint16_t mavlink_msg_scan_settings_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
                               float yaw_start, float yaw_stop, float pitch_start, float pitch_stop, float point_spacing, float scan_speed)
{
    ...
    _mav_put_float(buf, 16, point_spacing);
    _mav_put_float(buf, 20, scan_speed);
...
{
    return mavlink_msg_scan_settings_pack(system_id, component_id, msg, scan_settings->yaw_start, scan_settings->yaw_stop, scan_settings->pitch_start, scan_settings->pitch_stop, scan_settings->point_spacing, scan_settings->scan_speed);
}
...
{
    return mavlink_msg_scan_settings_pack_chan(system_id, component_id, chan, msg, scan_settings->yaw_start, scan_settings->yaw_stop, scan_settings->pitch_start, scan_settings->pitch_stop, scan_settings->point_spacing, scan_settings->scan_speed);
}
...
{
    return mavlink_msg_scan_settings_pack_status(system_id, component_id, _status, msg,  scan_settings->yaw_start, scan_settings->yaw_stop, scan_settings->pitch_start, scan_settings->pitch_stop, scan_settings->point_spacing, scan_settings->scan_speed);
}
...
static inline void mavlink_msg_scan_settings_send(mavlink_channel_t chan, float yaw_start, float yaw_stop, float pitch_start, float pitch_stop, float point_spacing, float scan_speed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    char buf[MAVLINK_MSG_ID_SCAN_SETTINGS_LEN];
    _mav_put_float(buf, 0, yaw_start);
...
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_scan_settings_send(chan, scan_settings->yaw_start, scan_settings->yaw_stop, scan_settings->pitch_start, scan_settings->pitch_stop, scan_settings->point_spacing, scan_settings->scan_speed);
#else
 ...
 */
static inline void mavlink_msg_scan_settings_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  float yaw_start, float yaw_stop, float pitch_start, float pitch_stop, float point_spacing, float scan_speed)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
