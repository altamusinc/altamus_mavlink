...
typedef struct __mavlink_command_cancel_t {
 ...
 uint8_t target_system; /*<  System executing long running command. Should
      not be broadcast (0).*/
 ...
 *
 * @param target_system  System executing long running command. Should
      not be broadcast (0).
 ...
 *
 * @return  System executing long running command. Should
      not be broadcast (0).
 */
