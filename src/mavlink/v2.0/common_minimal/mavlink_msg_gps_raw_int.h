...
typedef struct __mavlink_gps_raw_int_t {
 uint64_t time_usec; /*< [us] Timestamp (UNIX Epoch time or time
 ...
 int32_t alt; /*< [mm] Altitude (MSL). Positive for up. Note that
 ...
 uint16_t vel; /*< [cm/s] GPS ground speed. If
 ...
 int32_t alt_ellipsoid; /*< [mm] Altitude (above WGS84, EGM96
 ...
 uint16_t yaw; /*< [cdeg] Yaw in earth frame from
 ...
 * @param epv  GPS VDOP
          vertical dilution of position (unitless * 100). If unknown, set to: UINT16_MAX
 * @param vel [cm/s] GPS ground speed. If
          unknown, set to: UINT16_MAX
 * @param cog [cdeg] Course over ground
          (NOT heading, but direction of movement) in degrees * 100, 0.0..359.99 degrees. If
          unknown, set to: UINT16_MAX
 * @param satellites_visible  Number of satellites
          visible. If unknown, set to UINT8_MAX
 * @param alt_ellipsoid [mm] Altitude (above WGS84, EGM96
          ellipsoid). Positive for up.
 ...
 * @param yaw [cdeg] Yaw in earth frame from
          north. Use 0 if this GPS does not provide yaw. Use UINT16_MAX if this GPS is
          configured to provide yaw and is currently unable to provide it. Use 36000 for
          north.
 ...
 *
 * @return [us] Timestamp (UNIX Epoch time or time
          since system boot). The receiving end can infer timestamp format (since 1.1.1970 or
          since system boot) by checking for the magnitude of the number.
 */
 ...
 *
 * @return [mm] Altitude (MSL). Positive for up. Note that
          virtually all GPS modules provide the MSL altitude in addition to the WGS84
          altitude.
 */
 ...
 *
 * @return [cm/s] GPS ground speed. If
          unknown, set to: UINT16_MAX
 */
 ...
 *
 * @return [mm] Altitude (above WGS84, EGM96
          ellipsoid). Positive for up.
 */
 ...
 *
 * @return [cdeg] Yaw in earth frame from
          north. Use 0 if this GPS does not provide yaw. Use UINT16_MAX if this GPS is
          configured to provide yaw and is currently unable to provide it. Use 36000 for
          north.
 */
