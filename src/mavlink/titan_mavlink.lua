...
local enumEntryName = {
    ...
    ["BADGE_AUTH_STATE"] = {
        [1] = "BADGE_AUTH_STATE_UNKNOWN",
        [2] = "BADGE_AUTH_STATE_VERIFYING",
        [3] = "BADGE_AUTH_STATE_REJECTED",
        [4] = "BADGE_AUTH_STATE_AUTHORIZED",
    },
    ["MAV_AUTOPILOT"] = {
...
f.STATION_STATE_indicator_state = ProtoField.new("indicator_state (uint8_t)", "mavlink_proto.STATION_STATE_indicator_state", ftypes.UINT8, nil)
...
f.TRUCK_INFO_badge_id_int = ProtoField.new("badge_id_int (uint64_t)", "mavlink_proto.TRUCK_INFO_badge_id_int", ftypes.UINT64, nil)
f.TRUCK_INFO_truck_name = ProtoField.new("truck_name (char)", "mavlink_proto.TRUCK_INFO_truck_name", ftypes.STRING, nil)
f.TRUCK_INFO_arrival_time = ProtoField.new("arrival_time (uint32_t) [s]", "mavlink_proto.TRUCK_INFO_arrival_time", ftypes.UINT32, nil)

f.VISIBLE_BADGES_badge_id_int_0 = ProtoField.new("badge_id_int[0] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_0", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_1 = ProtoField.new("badge_id_int[1] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_1", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_2 = ProtoField.new("badge_id_int[2] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_2", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_3 = ProtoField.new("badge_id_int[3] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_3", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_4 = ProtoField.new("badge_id_int[4] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_4", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_5 = ProtoField.new("badge_id_int[5] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_5", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_6 = ProtoField.new("badge_id_int[6] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_6", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_7 = ProtoField.new("badge_id_int[7] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_7", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_8 = ProtoField.new("badge_id_int[8] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_8", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_9 = ProtoField.new("badge_id_int[9] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_9", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_10 = ProtoField.new("badge_id_int[10] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_10", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_11 = ProtoField.new("badge_id_int[11] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_11", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_12 = ProtoField.new("badge_id_int[12] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_12", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_13 = ProtoField.new("badge_id_int[13] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_13", ftypes.UINT64, nil)
f.VISIBLE_BADGES_badge_id_int_14 = ProtoField.new("badge_id_int[14] (uint64_t)", "mavlink_proto.VISIBLE_BADGES_badge_id_int_14", ftypes.UINT64, nil)
f.VISIBLE_BADGES_auth_state_0 = ProtoField.new("auth_state[0] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_0", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_1 = ProtoField.new("auth_state[1] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_1", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_2 = ProtoField.new("auth_state[2] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_2", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_3 = ProtoField.new("auth_state[3] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_3", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_4 = ProtoField.new("auth_state[4] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_4", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_5 = ProtoField.new("auth_state[5] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_5", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_6 = ProtoField.new("auth_state[6] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_6", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_7 = ProtoField.new("auth_state[7] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_7", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_8 = ProtoField.new("auth_state[8] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_8", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_9 = ProtoField.new("auth_state[9] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_9", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_10 = ProtoField.new("auth_state[10] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_10", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_11 = ProtoField.new("auth_state[11] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_11", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_12 = ProtoField.new("auth_state[12] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_12", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_13 = ProtoField.new("auth_state[13] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_13", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_auth_state_14 = ProtoField.new("auth_state[14] (BADGE_AUTH_STATE)", "mavlink_proto.VISIBLE_BADGES_auth_state_14", ftypes.UINT8, enumEntryName.BADGE_AUTH_STATE)
f.VISIBLE_BADGES_arrival_time_0 = ProtoField.new("arrival_time[0] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_0", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_1 = ProtoField.new("arrival_time[1] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_1", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_2 = ProtoField.new("arrival_time[2] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_2", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_3 = ProtoField.new("arrival_time[3] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_3", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_4 = ProtoField.new("arrival_time[4] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_4", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_5 = ProtoField.new("arrival_time[5] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_5", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_6 = ProtoField.new("arrival_time[6] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_6", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_7 = ProtoField.new("arrival_time[7] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_7", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_8 = ProtoField.new("arrival_time[8] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_8", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_9 = ProtoField.new("arrival_time[9] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_9", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_10 = ProtoField.new("arrival_time[10] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_10", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_11 = ProtoField.new("arrival_time[11] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_11", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_12 = ProtoField.new("arrival_time[12] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_12", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_13 = ProtoField.new("arrival_time[13] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_13", ftypes.UINT32, nil)
f.VISIBLE_BADGES_arrival_time_14 = ProtoField.new("arrival_time[14] (uint32_t) [s]", "mavlink_proto.VISIBLE_BADGES_arrival_time_14", ftypes.UINT32, nil)
...
function payload_fns.payload_4(buffer, tree, msgid, offset, limit, pinfo)
    ...
    subtree = tree:add_le(f.STATION_STATE_indicator_state, tvbrange)
end
...
-- dissect payload of message type TRUCK_INFO
function payload_fns.payload_8(buffer, tree, msgid, offset, limit, pinfo)
    ...
    tvbrange = padded(offset + 0, 8)
    subtree = tree:add_le(f.TRUCK_INFO_badge_id_int, tvbrange)
    tvbrange = padded(offset + 12, 20)
    subtree = tree:add_le(f.TRUCK_INFO_truck_name, tvbrange)
    tvbrange = padded(offset + 8, 4)
    subtree = tree:add_le(f.TRUCK_INFO_arrival_time, tvbrange)
end
-- dissect payload of message type VISIBLE_BADGES
function payload_fns.payload_9(buffer, tree, msgid, offset, limit, pinfo)
    local padded, field_offset, value, subtree, tvbrange
    if (offset + 195 > limit) then
        padded = buffer(0, limit):bytes()
        padded:set_size(offset + 195)
        padded = padded:tvb("Untruncated payload")
    else
        padded = buffer
    end
    tvbrange = padded(offset + 0, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_0, tvbrange)
    tvbrange = padded(offset + 8, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_1, tvbrange)
    tvbrange = padded(offset + 16, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_2, tvbrange)
    tvbrange = padded(offset + 24, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_3, tvbrange)
    tvbrange = padded(offset + 32, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_4, tvbrange)
    tvbrange = padded(offset + 40, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_5, tvbrange)
    tvbrange = padded(offset + 48, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_6, tvbrange)
    tvbrange = padded(offset + 56, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_7, tvbrange)
    tvbrange = padded(offset + 64, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_8, tvbrange)
    tvbrange = padded(offset + 72, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_9, tvbrange)
    tvbrange = padded(offset + 80, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_10, tvbrange)
    tvbrange = padded(offset + 88, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_11, tvbrange)
    tvbrange = padded(offset + 96, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_12, tvbrange)
    tvbrange = padded(offset + 104, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_13, tvbrange)
    tvbrange = padded(offset + 112, 8)
    subtree = tree:add_le(f.VISIBLE_BADGES_badge_id_int_14, tvbrange)
    tvbrange = padded(offset + 180, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_0, tvbrange)
    tvbrange = padded(offset + 181, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_1, tvbrange)
    tvbrange = padded(offset + 182, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_2, tvbrange)
    tvbrange = padded(offset + 183, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_3, tvbrange)
    tvbrange = padded(offset + 184, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_4, tvbrange)
    tvbrange = padded(offset + 185, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_5, tvbrange)
    tvbrange = padded(offset + 186, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_6, tvbrange)
    tvbrange = padded(offset + 187, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_7, tvbrange)
    tvbrange = padded(offset + 188, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_8, tvbrange)
    tvbrange = padded(offset + 189, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_9, tvbrange)
    tvbrange = padded(offset + 190, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_10, tvbrange)
    tvbrange = padded(offset + 191, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_11, tvbrange)
    tvbrange = padded(offset + 192, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_12, tvbrange)
    tvbrange = padded(offset + 193, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_13, tvbrange)
    tvbrange = padded(offset + 194, 1)
    subtree = tree:add_le(f.VISIBLE_BADGES_auth_state_14, tvbrange)
    tvbrange = padded(offset + 120, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_0, tvbrange)
    tvbrange = padded(offset + 124, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_1, tvbrange)
    tvbrange = padded(offset + 128, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_2, tvbrange)
    tvbrange = padded(offset + 132, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_3, tvbrange)
    tvbrange = padded(offset + 136, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_4, tvbrange)
    tvbrange = padded(offset + 140, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_5, tvbrange)
    tvbrange = padded(offset + 144, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_6, tvbrange)
    tvbrange = padded(offset + 148, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_7, tvbrange)
    tvbrange = padded(offset + 152, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_8, tvbrange)
    tvbrange = padded(offset + 156, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_9, tvbrange)
    tvbrange = padded(offset + 160, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_10, tvbrange)
    tvbrange = padded(offset + 164, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_11, tvbrange)
    tvbrange = padded(offset + 168, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_12, tvbrange)
    tvbrange = padded(offset + 172, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_13, tvbrange)
    tvbrange = padded(offset + 176, 4)
    subtree = tree:add_le(f.VISIBLE_BADGES_arrival_time_14, tvbrange)
end
